+++
title = "Baking a simple white loaf"
description = "Demo guide: mixing, kneading, proving and baking one everyday loaf."
template = "article.html"
draft = false

[extra]
kind = "guide"
related = ["procedures/baking-bread/understanding-proofing/index.md", "procedures/baking-bread/flour-and-hydration/index.md"]
+++

## Overview

This published, non-clinical demonstration makes one loaf in a roughly 900 g loaf tin. Allow around three hours, including rising and baking, plus cooling time. The dough's appearance matters more than the clock.
...
| Water, lukewarm | 320 g |
| Instant yeast | 7 g |
| Fine salt | 10 g |
| Olive oil | 15 g, plus a little for the tin |

{% <checklist title="Before you start"> %}
- Weigh the ingredients using kitchen scales.
- Set out a large bowl, a dough scraper and a loaf tin.
...
3. Knead on a clean worktop for about 8–10 minutes, until the dough feels smoother and elastic.

{% <callout kind="tip" title="Give sticky dough a moment"> %}
...
1. Lightly oil the tin.
2. Gently flatten the dough into a rectangle about as wide as the tin is long.
...
{% <callout kind="warning" title="Hot tin"> %}
...
| What you notice | What to try next time |
| --- | --- |
| Dense, tightly packed crumb | Allow more rising time and check that the yeast is active. |
| Dry, heavy dough | Weigh the water and use less flour on the worktop. |
| Pale sides | Remove the tin for the last few minutes of baking. |
